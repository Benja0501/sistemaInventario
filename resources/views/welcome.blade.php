...
<body
    ...
    <head>
        <meta charset="utf-8">
        <meta name="viewport" content="width=device-width, initial-scale=1">
        <title>FEMAZA S.A. - Sistema de Inventario</title>
        <link rel="preconnect" href="https://fonts.bunny.net">
        <link href="https://fonts.bunny.net/css?family=instrument-sans:400,500,600" rel="stylesheet" />
        <style>
            /*! tailwindcss v4.0.7 | MIT License | https://tailwindcss.com */
            @layer theme {
                :root {
                    ...
                    /* ... (se mantienen todos los estilos base de Tailwind) ... */
                }
            }
    ...
    <body class="bg-[#FDFDFC] text-[#1b1b18] flex items-center justify-center min-h-screen p-6 lg:p-8">
        <div class="flex items-center justify-center w-full transition-opacity opacity-100 duration-750">
            <main class="flex max-w-[335px] w-full flex-col lg:max-w-4xl lg:flex-row shadow-lg rounded-lg">

                {{-- =============================================== --}}
                {{-- SECCIÓN DEL FORMULARIO DE LOGIN (MODIFICADA) --}}
                {{-- =============================================== --}}
                <div class="text-[13px] leading-[20px] flex-1 p-6 lg:p-20  rounded-l-lg bg-gray-100 border-4 border-white">
                    <h1 class="mb-2 text-2xl font-bold">Bienvenido</h1>
                    <p class="mb-6 text-[#706f6c]">Inicia sesión para acceder al sistema.</p>

                    {{-- Mostramos errores de login si existen --}}
                    @if ($errors->any())
                        <div class="mb-4 bg-[#fff2f2] border border-red-400 text-red-700 px-4 py-3 rounded relative"
                            role="alert">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        @csrf
                        <div class="mb-4">
                            <label for="email" class="block font-medium text-sm text-[#1b1b18]">Correo
                                Electrónico</label>
                            <input id="email" type="email" name="email" :value="old('email')" required
                                autofocus class="form-input mt-1">
                        </div>

                        <div class="mb-4">
                            <label for="password" class="block font-medium text-sm text-[#1b1b18]">Contraseña</label>
                            <input id="password" type="password" name="password" required class="form-input mt-1">
                        </div>
                ...
                {{-- =============================================== --}}
                <div
                    class="bg-[#009688] relative lg:-ml-px rounded-r-lg aspect-[335/376] lg:aspect-auto w-full lg:w-[438px] shrink-0 overflow-hidden flex items-center justify-center p-8 border-4 border-white">
                    {{-- NOTA: Asegúrate de que la ruta a tu logo sea correcta en la carpeta /public --}}
                    <img src="{{ asset('assets/images/logo_dark.png') }}" alt="Logo de FEMAZA"
